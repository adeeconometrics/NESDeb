...
auto Cartridge::read_cpu(uint16_t address, uint8_t &data) -> bool {
...
auto Cartridge::read_ppu(uint16_t address, uint8_t &data) -> bool {
...
auto Cartridge::is_valid_image() -> bool { return m_is_valid_image; }
